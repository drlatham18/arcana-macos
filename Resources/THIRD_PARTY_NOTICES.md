...
The self-contained app includes CPython 3.12.14, built by Astral's python-build-standalone project, release 20260901. Python and bundled dependency license files remain inside `Contents/Resources/runtime/<architecture>/python/`, including `lib/python3.12/LICENSE.txt` and package-specific license files. Runtime source and build information: https://github.com/astral-sh/python-build-standalone.

The Arcana icon and interface artwork were created for this project and do not use official Magic artwork.
